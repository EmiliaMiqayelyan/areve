...
export const SITE_CONTENT_EN = {
  ...
  home: {
    collectionsSection: {
      ...
      subtitle: "Bags, toys, and accessories — all handmade.",
    },
    hero: {
      ...
      titleAccent: "beauty",
      subtitle:
        "Beaded bags and accessories — one of a kind, made by hand, made for you.",
      trustLine: "100% handmade · Every piece is unique",
    ...
    storySection: {
      ...
      eyebrow: "AREVÉ",
      titleLine1: "Made with",
      titleItalic: "love,",
      titleLine2: "crafted by hand",
      paragraphs: [
        "Every piece is made by hand — with care, patience, and attention to detail.",
        "AREVÉ is sunlight in everyday life — warm, unique, and made for you.",
      ],
      pillars: [
        { icon: "✦", label: "Handmade" },
        { icon: "☀️", label: "Unique" },
    ...
    testimonialsSection: {
      ...
      subtitle: "Real words from people who chose AREVÉ.",
      readAllLabel: "All Reviews",
    },
    instagramSection: {
      eyebrow: "@areve.handmade",
      title: "Follow Along",
      subtitle: "New drops, behind the scenes, daily inspiration.",
      viewLinkLabel: "Instagram →",
    },
    ctaSection: {
      emoji: "☀️",
      titleLine1: "Want something",
      titleItalic: "one of a kind?",
      paragraph: "Custom orders — your colors, our hands.",
