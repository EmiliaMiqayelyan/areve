            ...
            <motion.div key={i}
              ...
              <button onClick={() => setOpen(open === i ? null : i)}
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                  <span style={{ width: 28, height: 28, borderRadius: '50%', background: open === i ? '#E6C97A' : '#EADFD8', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Playfair Display',serif", fontSize: 13, fontWeight: 700, color: open === i ? '#5a4a1e' : '#AFAFAF', flexShrink: 0 }}>
                    {i + 1}
                  </span>
