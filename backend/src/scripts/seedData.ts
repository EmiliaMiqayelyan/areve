...
import { Faq, Gallery, Order, OrderItem, Product, Review } from "../models";
...
async function seed() {
  ...
  await OrderItem.bulkCreate([
    { id: randomUUID(), orderId: "ORD-1004", productId: "7", productName: "Sun Drops Set", quantity: 1, unitPrice: 58 },
    { id: randomUUID(), orderId: "ORD-1005", productId: "1", productName: "Golden Sunburst Clutch", quantity: 1, unitPrice: 89 },
  ]);
