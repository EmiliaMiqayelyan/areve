...
exports.DEFAULT_SITE_CONTENT = void 0;
/** Merged with DB `settings.site_content`; drives the public storefront copy and structure. */
exports.DEFAULT_SITE_CONTENT = {
    metadata: {
        title: 'AREVÉ — Ձեռագործ՝ ջերմությամբ և արևի լույսով',
        description: 'Բացահայտեք AREVÉ-ի ձեռագործ բիջակապարց տոպրակները, եզակի խաղալիքներն ու արհեստավոր աքսեսուարները։ Յուրաքանչյուր կտոր ստեղծված է սիրով, ջերմությամբ և արևի լույսով։',
    },
    nav: [
        { href: '/', label: 'Գլխավոր' },
