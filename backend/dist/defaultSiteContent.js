...
exports.DEFAULT_SITE_CONTENT = {
    ...
    home: {
        ...
        hero: {
            ...
            subtitle: 'AREVÉ-ի յուրաքանչյուր կտոր կրում է հոգատար ձեռքերի ջերմությունը — բիջակապարց տոպրակներ, սրտանց խաղալիքներ և աքսեսուարներ, որոնք պատմում են ձեր պատմությունը։',
            stats: [
        ...
        ctaSection: {
            ...
            paragraph: 'Մենք ընդունում ենք անհատական պատվերներ — ձեր գույներն, ձեր տեսլականը, մեր ձեռքերը։ Ստեղծենք միասին։',
